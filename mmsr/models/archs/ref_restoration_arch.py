...
class DynamicAggregationRestoration(nn.Module):
    ...
    def __init__(self, ngf=64, n_blocks=16, groups=8):
        ...
        self.small_offset_conv1 = nn.Conv2d(1856, 256, 3, 1, 1, bias=True)
        ...
        self.medium_offset_conv1 = nn.Conv2d(512, 128, 3, 1, 1, bias=True)
        ...
        self.large_offset_conv1 = nn.Conv2d(176, 64, 3, 1, 1, bias=True)
        ...
        self.down4 = nn.PixelUnshuffle(4)
    ...
    def forward(self, x, pre_offset, img_ref_feat):
        ...
        ref_feat_x1_x1 = img_ref_feat['relu3_1'] ##(b,256,40,40)
        ref_feat_x1_up2 = self.up2(ref_feat_x1_x1) ##(b,64,80,80)
        ref_feat_x1_up4 = self.up4(ref_feat_x1_x1) ##(b,16,160,160)

        ref_feat_x2_x1 = img_ref_feat['relu2_1'] ##(b,128,80,80)
        ref_feat_x2_up2 = self.up2(ref_feat_x2_x1) ##(b,32,160,160)
        ref_feat_x2_down2 = self.down2(ref_feat_x2_x1) ##(b,512,40,40)

        ref_feat_x4_x1 = img_ref_feat['relu1_1'] ##(b,64,160,160)
        ref_feat_x4_down2 = self.down2(ref_feat_x4_x1) ##(b,256,80,80)
        ref_feat_x4_down4 = self.down4(ref_feat_x4_x1) ##(b,1024,40,40


        # dynamic aggregation for relu3_1 reference feature #[b,64,40,40]+[b,256,40,40]
        relu3_offset = torch.cat([x,ref_feat_x1_x1,ref_feat_x2_down2,ref_feat_x4_down4], 1)
        ...
        relu2_offset = torch.cat([x,ref_feat_x2_x1,ref_feat_x1_up2,ref_feat_x4_down2], 1)##b=64+128+64+256=512
        ...
        relu1_offset = torch.cat([x, ref_feat_x4_x1,ref_feat_x2_up2,ref_feat_x1_up4], 1) #b=64+64+16+32=176
